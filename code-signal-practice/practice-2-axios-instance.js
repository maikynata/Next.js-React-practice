...
export default function SpacePosts() {
  ...
  useEffect(() => {
    instance.get('2b0722g9-39d6-4acc-87bb-ee7c7339f880') // TODO: Update this code to have axios instance with predefined URL, and then update this call to get resource with the given ID.
      .then(response => {
